...
export default function Moods() {
  ...
  const makeHappy = () => {
    /* STEP 4 */
    setMood(happyMood)
    document.getElementById('mood').textContent = happyMood
  };
  const makeSad = () => {
    /* STEP 5 */
    setMood(sadMood)
    document.getElementById('mood').textContent = sadMood
  };
  const reset = () => {
    /* STEP 6 */
    setMood(initialMood)
    document.getElementById('mood').textContent = initialMood
  };
